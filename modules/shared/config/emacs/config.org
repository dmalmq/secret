...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "dmalmq"
    user-mail-address "dnlmalmqvist@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/danielmalmqvist/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/danielmalmqvist/bin" "/profile/bin" "/Users/danielmalmqvist/.npm-packages/bin" "/Users/danielmalmqvist/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
